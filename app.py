...
def index() -> 'html':
    if request.method == 'POST':
        newComment = Comment(name=request.form['name'], email=request.form['email'], subject=request.form['subject'], message=request.form['message'])
        session.add(newComment)
        session.commit()
        mail(request.form['subject'], request.form['email'], request.form['message'], request.form['name'])
